...
public class MigrationAssistantBeanConfiguration {
    ...
    @Bean
    Supplier<AutoScalingClient> autoScalingClient(AwsCredentialsProvider credentialsProvider, RegionService regionService) {
    ...
    @Bean
    Supplier<SqsAsyncClient> sqsAsyncClient(AwsCredentialsProvider awsCredentialsProvider, RegionService regionService) {
    ...
    @Bean
    Supplier<Ec2Client> ec2Client(AwsCredentialsProvider awsCredentialsProvider, RegionService regionService) {
    ...
    public EncryptionManager encryptionManager() {
        // FIXME
        return new EncryptionManager(Paths.get("/var/atlassian/application-data/confluence"));
    }
    ...
    @Bean
    public UploaderFactory uploaderFactory(AWSMigrationHelperDeploymentService helperDeploymentService, Supplier<S3AsyncClient> clientSupplier) {
        return new S3UploaderFactory(helperDeploymentService, clientSupplier, Paths.get("/var/atlassian/application-data/confluence"));
    }
    ...
    @Bean
    public S3BulkCopy s3BulkCopy(FilesystemUploaderFactory filesystemUploaderFactory, FileSystemMigrationReportManager reportManager) {
        return new S3BulkCopy(Paths.get("/var/atlassian/application-data/confluence"), filesystemUploaderFactory, reportManager);
    }
